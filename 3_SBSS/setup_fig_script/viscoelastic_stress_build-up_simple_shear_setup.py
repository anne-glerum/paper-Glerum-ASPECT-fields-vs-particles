...
ax.text(0.05,0.50,'Periodic',fontsize=9, rotation = 90, va = 'center', ha = 'center')
ax.text(0.95,0.50,'Periodic',fontsize=9, rotation = 90, va = 'center', ha = 'center')
...
ax.text(1.01,0.94,'$\mathrm{if} \, (t \leq t_{max})$', fontsize=8)
ax.text(1.01,0.90,'  $\mathrm{v_x}=0.3 y + 10^{-10}$ [m/s]', fontsize=8)
ax.text(1.01,0.86,'else', fontsize=8)
ax.text(1.01,0.82,'  $\mathrm{v_x}=10^{-10}$ [m/s]', fontsize=8)
ax.text(1.01,0.75,'$\mathrm{v_y}=0$ [m/s]', fontsize=8)
...
ax.text(0.35,0.80,'$\eta_{\mathrm{viscous}}=10^{2} \,\mathrm{Pa} \cdot \mathrm{s}$\n$G=10^{2} \, \mathrm{Pa}$', fontsize=9, ha='left')

# Annotations material properties
ax.text(0.35,0.50,'$\mathrm{if} \, (t \leq t_{max})$', fontsize=8)
ax.text(0.35,0.45,r'  $\dot{\epsilon} = \binom{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0.15}{0.15 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}$ 1/s', fontsize=9, ha='left', va='center')
ax.text(0.35,0.38,r'  $W = \binom{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0.15}{-0.15 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}$ 1/s', fontsize=9, ha='left', va='center')
ax.text(0.35,0.33,'else', fontsize=8)
ax.text(0.35,0.28,r'  $\dot{\epsilon} = \binom{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}$ 1/s', fontsize=9, ha='left', va='center')
ax.text(0.35,0.21,r'  $W = \binom{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}{0 \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}$ 1/s', fontsize=9, ha='left', va='center')
