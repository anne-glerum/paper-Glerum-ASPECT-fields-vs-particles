...
names = [
         ...
         "ve_build-up_simple_shear_particles_periodic_interpolatornearest_neighbor_dtc0.01_dte0.01_GR2_np4",
         "ve_build-up_simple_shear_particles_periodic_interpolatorbilinear_least_squares_dtc0.01_dte0.01_GR2_np4",
         "ve_build-up_simple_shear_particles_periodic_interpolatorquadratic_least_squares_dtc0.01_dte0.01_GR2_np4",
        ]
tail = r"/statistics"
...
for name in names: 
  ...
  time,stress_xy_min = np.genfromtxt(path, comments='#', usecols=(1,20), unpack=True)
  time,stress_xy_max = np.genfromtxt(path, comments='#', usecols=(1,21), unpack=True)
  ...
  ax[0].plot(time,stress_xy_min,label=None,color=colors[counter],linestyle='dashed',marker=markers[counter],markevery=dmark,fillstyle='none')
  ax[0].plot(time,stress_xy_max,label=None,color=colors[counter],linestyle='dashed',marker=markers[counter],markevery=dmark,fillstyle='none')
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_interpolator.png')    
