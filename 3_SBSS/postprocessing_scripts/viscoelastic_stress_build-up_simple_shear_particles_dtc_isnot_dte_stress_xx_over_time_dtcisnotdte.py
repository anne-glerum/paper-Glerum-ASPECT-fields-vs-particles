...
names = [
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.02_dte0.02_GR2_np4_1",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.01_dte0.02_GR2_np4_1",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.005_dte0.02_GR2_np4_1",
#         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.0025_dte0.02_GR2_np4_1",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.01_dte0.01_GR2_np4_1",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.005_dte0.01_GR2_np4_1",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.0025_dte0.01_GR2_np4_1",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_dtcisnotdte.png')    
