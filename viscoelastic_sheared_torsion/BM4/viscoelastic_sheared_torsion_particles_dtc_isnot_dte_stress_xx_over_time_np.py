...
names = [
         ...
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR1_np16",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR1_np32",
        ]
tail = r"/statistics"
...
colors = [color2, color4, color5, color6, color5, color6, color3, color5]
# Set the line styles
