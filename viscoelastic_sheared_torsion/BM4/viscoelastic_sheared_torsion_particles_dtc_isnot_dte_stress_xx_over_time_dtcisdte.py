...
names = [
         ...
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.005_dte0.005_GR1_np4",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 0.02 s, dh = 0.5 m',
          'dtc = dte = 0.01 s, dh = 0.5 m',
          'dtc = dte = 0.005 s, dh = 0.5 m',
         ]
...
colors = [color2, color4, color5, color5, color6, color1, color3, color5]
# Set the line styles
...
# Save
plt.savefig('4_viscoelastic_sheared_torsion_particles_dtc_isnot_dte_dtcisdte.png')    
