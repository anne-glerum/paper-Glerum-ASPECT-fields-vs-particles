...
names = [
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.02_dte0.02_GR1_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.02_GR1_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.005_dte0.02_GR1_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR1_np4_g0",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.005_dte0.01_GR1_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.0025_dte0.01_GR1_np4",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('4_viscoelastic_sheared_torsion_particles_dtc_isnot_dte_dtcisnotdte.png')    
