...
for name in names: 
  ...
  ax1.text(counter,beam_depth[-1]-3,r'{0:.0f}'.format(beam_depth[-1]),fontsize=9,color=colors[counter])
...
ax1.set_title("Fields, htan10m, Newton, AMG, geometric, IGR2, IAR1", fontsize=6)
...
# Save as pdf
filename = '5_viscoelastic_bending_beam_dte_isnot_dtc_main_maxdeptherror_dt.png'
