...
names = [
         'RL9_viscoelastic_bending_beam_smooth_particles_Newton_avegeometric_intcell_average_limTrue_dtc500_dte500_IGR2_IAR0_np4',
         'RL9_viscoelastic_bending_beam_smooth_particles_Newton_avegeometric_intnearest_neighbor_limTrue_dtc500_dte500_IGR2_IAR0_np4',
         'RL9_viscoelastic_bending_beam_smooth_particles_Newton_avegeometric_intbilinear_least_squares_limTrue_dtc500_dte500_IGR2_IAR0_np4',
         ...
         'RL9_viscoelastic_bending_beam_smooth_particles_Newton_avegeometric_intdistance_weighted_average_limTrue_dtc500_dte500_IGR2_IAR0_np4',
        ]
tail = r"/statistics"
...
# for G = 1e10 Pa
# L = 4800 m (4812.5 m for a smooth beam with dx = 25 m)
# h = 600 m (625 m for a smooth beam with dx = 25 m)
# E 3G Pa
# D = 72e6 G = (E h^3) / (12(1-v^2))
# q = 3e6 kg/(ms^2)
...
# Save as pdf
filename = '5_viscoelastic_bending_beam_dte_particles_isnot_dtc_depth_dtcisdte_PI.png'
