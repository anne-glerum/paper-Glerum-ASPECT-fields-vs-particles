...
names = [
         "SS_test_particles_dtcdte0.01_NI1_GR2_notperiodic",
         "SS_test_particles_dtcdte0.01_NI10_GR2_notperiodic",
         "SS_test_particles_dtcdte0.01_NI20_GR2_notperiodic",
         "SS_test_particles_dtcdte0.01_NI40_GR2_notperiodic",
         "SS_test_particles_dtcdte0.01_NI80_GR2_notperiodic",
#         "SS_test_particles_dtcdte0.01_NI10_GR2_notperiodic_singleAdv",
         "../../../../../../../../../../Applications/ASPECT/VisualStudioCode/runs__fix_stresses_elasticity/SS_test_particles_dtcdte0.0025_NI10_GR2_notperiodic",
         "../../../../../../../../../../Applications/ASPECT/VisualStudioCode/runs__fix_stresses_elasticity/SS_test_particles_dtcdte0.0025_NI20_GR2_notperiodic",
         "../../../../../../../../../../Applications/ASPECT/VisualStudioCode/runs__fix_stresses_elasticity/SS_test_particles_dtcdte0.0025_NI50_GR2_notperiodic",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc=dte=0.01 s, W^(t), GR=2, NI=1',
          'dtc=dte=0.01 s, W^(t), GR=2, NI=10',
          'dtc=dte=0.01 s, W^(t), GR=2, NI=20',
          'dtc=dte=0.01 s, W^(t), GR=2, NI=40',
          'dtc=dte=0.01 s, W^(t), GR=2, NI=80',
#          'dtc=dte=0.01 s, W^(t), GR=2, NI=10, single Advection',
          'dtc=dte=0.0025 s, W^(t), GR=2, NI=10, OS on particles',
          'dtc=dte=0.0025 s, W^(t), GR=2, NI=20, OS on particles',
          'dtc=dte=0.0025 s, W^(t), GR=2, NI=50, OS on particles',
         ]
...
# Set the line styles
linestyles = ['solid', 'solid', 'solid', 'solid', 'solid', 'dashed', 'dashed', 'dashed'] 
...
ax[1].set_xlim(0,1.) # s
ax[1].set_ylim(-2.5,0.05) # %

# Add labels a) and b)
ax[0].text(-0.055,15.5,"a)")
ax[1].text(-0.07,0.05,"b)")
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_SS_NI_noOS.png')    
