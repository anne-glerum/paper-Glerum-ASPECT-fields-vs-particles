...
names = [
         ...
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.001_dte0.001_GR0_np4_g0",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_dtcisdte.png')    
