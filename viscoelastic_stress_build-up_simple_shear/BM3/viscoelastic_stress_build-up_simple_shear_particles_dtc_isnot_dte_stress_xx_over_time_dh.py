...
names = [
         "ve_build-up_simple_shear_particles_periodic_interpolatorcell_average_dtc0.01_dte0.01_GR0_np4_g0",
         "ve_build-up_simple_shear_particles_periodic_interpolatorcell_average_dtc0.01_dte0.01_GR4_np4_g0",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.005_dte0.005_GR0_np4_g0",
         "ve_build-up_simple_shear_particles_periodic_interpolatorcell_average_dtc0.005_dte0.005_GR8_np4_g0",
         "ve_build-up_simple_shear_periodic_dtc0.005_dte0.005_GR8",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 0.01 s, dh = 1 m, periodic',
          'dtc = dte = 0.01 s, dh = 0.03125 m, periodic',
          'dtc = dte = 0.005 s, dh = 1 m',
          'dtc = dte = 0.005 s, dh = 0.00391 m, periodic',
          'dtc = dte = 0.005 s, dh = 0.00391 m, periodic, fields',
         ]
...
colors = [color2, color3, color4, color5, color6, color6, color5, color1, color3, color5]
# Set the line styles
...
for name in names: 
  ...
  ax[1].plot(time,(stress_xy_min-tau_xy_analytical(time))/tau_xy_analytical(time)*100.,label=None,color=colors[counter],linestyle=linestyles[counter],marker=markers[counter],markevery=dmark)
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_dh.png')    
