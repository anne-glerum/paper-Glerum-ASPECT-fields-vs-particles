...
names = [
         ...
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.01_dte0.01_GR0_np16_g0",
         "ve_build-up_simple_shear_particles_interpolatorcell_average_dtc0.01_dte0.01_GR0_np128_g0",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_particles_dtc_isnot_dte_np.png')    
