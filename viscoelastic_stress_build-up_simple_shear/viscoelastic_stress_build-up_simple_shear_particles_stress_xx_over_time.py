...
names = [
         "ve_build-up_simple_shear_particles_dt0.002_GR3",
         "ve_build-up_simple_shear_particles_dt0.002_GR4",
         "ve_build-up_simple_shear_particles_dt0.002_GR5",
         "ve_build-up_simple_shear_particles_dt0.001_GR3",
         "ve_build-up_simple_shear_particles_dt0.001_GR4",
         "ve_build-up_simple_shear_particles_dt0.001_GR5",
         "ve_build-up_simple_shear_particles_dt0.0005_GR3",
         "ve_build-up_simple_shear_particles_dt0.0005_GR4",
         "ve_build-up_simple_shear_particles_dt0.0005_GR5",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dt = 0.002 s, dh = 0.125 m, part.',
          'dt = 0.002 s, dh = 0.0625 m, part.',
          'dt = 0.002 s, dh = 0.03125 m, part.',
          'dt = 0.001 s, dh = 0.125 m, part.',
          'dt = 0.001 s, dh = 0.0625 m, part.',
          'dt = 0.001 s, dh = 0.03125 m, part.',
          'dt = 0.0005 s, dh = 0.125 m, part.',
          'dt = 0.0005 s, dh = 0.0625 m, part.',
          'dt = 0.0005 s, dh = 0.03125 m, part.',
         ]
...
ax[1].legend(loc='upper left',ncol=2,handlelength=3)
# Grid and tickes
...
# Save as pdf
plt.savefig('3_viscoelastic_build-up_simple_shear_particles.pdf')    
