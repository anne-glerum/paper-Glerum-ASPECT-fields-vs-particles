...
names = [
         "SS_test_dtcdte0.01_NI10_GR2",
         "SS_test_dtcdte0.01_NI20_GR2",
         "SS_test_dtcdte0.01_NI40_GR2",
         "SS_test_dtcdte0.01_NI80_GR2",
#         "SS_test_6",
        ]
tail = r"/statistics"
...
labels = [
          "dtc = dte = 0.01, W^(t), GR = 2, NI = 10",
          "dtc = dte = 0.01, W^(t), GR = 2, NI = 20",
          "dtc = dte = 0.01, W^(t), GR = 2, NI = 40",
          "dtc = dte = 0.01, W^(t), GR = 2, NI = 80",
...
colors = [color1, color3, color5, color6, color5, color6, 'black', 'red', 'blue',color4, color1, color3, color5]
# Set the line styles
...
# Save
plt.savefig('3_viscoelastic_build-up_simple_shear_dtc_isnot_dte_dt_SS_test_NI_GR2.png')
