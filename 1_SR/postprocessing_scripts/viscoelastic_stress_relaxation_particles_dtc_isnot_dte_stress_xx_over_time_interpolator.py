...
names = [
         ...
         "ve_relaxation_particles_main_interpolatornearest_neighbor_dtc250_dte250_GR4_np4_1",
         "ve_relaxation_particles_main_interpolatorbilinear_least_squares_dtc250_dte250_GR4_np4_1",
         "ve_relaxation_particles_main_interpolatorquadratic_least_squares_dtc250_dte250_GR4_np4_1",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = 250 yr, dh = 6.25 km, CA',
          'dtc = 250 yr, dh = 6.25 km, NN',
          'dtc = 250 yr, dh = 6.25 km, LLS',
          'dtc = 250 yr, dh = 6.25 km, QLS',
         ]
