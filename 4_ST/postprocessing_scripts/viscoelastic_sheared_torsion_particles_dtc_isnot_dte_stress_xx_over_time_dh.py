...
names = [
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR1_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR2_np4",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR3_np4",
...
# Save
plt.savefig('4_viscoelastic_sheared_torsion_particles_dtc_isnot_dte_dh.png')    
