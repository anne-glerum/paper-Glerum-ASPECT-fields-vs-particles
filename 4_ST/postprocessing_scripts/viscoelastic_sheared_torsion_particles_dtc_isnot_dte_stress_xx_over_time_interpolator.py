...
names = [
         ...
         "ve_sheared_torsion_particles_interpolatorbilinear_least_squares_dtc0.01_dte0.01_GR2_np4",
         "ve_sheared_torsion_particles_interpolatorquadratic_least_squares_dtc0.01_dte0.01_GR2_np4",
        ]
tail = r"/statistics"
...
colors = [color1, color2, color3, color4, color6, color1, color3, color5]
# Set the line styles
...
# Save
plt.savefig('4_viscoelastic_sheared_torsion_particles_dtc_isnot_dte_interpolator.png')    
