...
names = [
         ...
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR2_np8",
         "ve_sheared_torsion_particles_interpolatorcell_average_dtc0.01_dte0.01_GR2_np16",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('4_viscoelastic_sheared_torsion_particles_dtc_isnot_dte_np.png')    
