...
ax[1].text(0,1.05,'(b) top view $t \leq t_{\mathrm{max}}$',fontsize=15)
...
ax[0].text(0.15,0.95,'Prescribed v',fontsize=9, va = 'center', ha = 'center')
...
ax[0].text(0.15,0.37,'$\mathrm{if} \, (t \leq 0.5)$', fontsize=8)
ax[0].text(0.15,0.32,'  $\mathrm{v_x}=-(42/360)R\mathrm{sin}(\phi) + 0.3 z$ m/s', fontsize=8)
ax[0].text(0.15,0.27,'  S = 0.15', fontsize=8)
ax[0].text(0.15,0.22,'else', fontsize=8)
ax[0].text(0.15,0.17,'  $\mathrm{v_x} = -(42/360)R\mathrm{sin}(\phi)$ m/s', fontsize=8)
ax[0].text(0.15,0.12,'  S = 0.0', fontsize=8)
ax[0].text(0.15,0.42,'$\mathrm{v_y}=(42/360)R\mathrm{cos}(\phi)$ m/s, $\mathrm{v_z}=0$ m/s', fontsize=8)
#ax[0].text(0.15,0.35,'$\mathrm{v_z}=0$ m/s', fontsize=8)
# Annotations material properties
ax[0].text(0.35,0.815,r'$\rho=1$ $\mathrm{kg/m^3}$', fontsize=9, ha='left', va='center')
ax[0].text(0.35,0.915,'$\eta_{\mathrm{viscous}}=10^{2} \,\mathrm{Pa} \cdot \mathrm{s}$\n$G=10^{2} \, \mathrm{Pa}$', fontsize=9, ha='left', va='center')
# Annotations material properties
ax[0].text(0.35,0.715,r'$\dot{\epsilon} = \left( \begin{matrix} 0 & 0 & S \\ 0 & 0 & 0 \\ S & 0 & 0 \end{matrix}\right)$ 1/s', fontsize=9, ha='left', va='center',usetex=True)
ax[0].text(0.35,0.545,r'$W = \left( \begin{matrix} 0 & -0.12 & S \\ 0.12 & 0 & 0 \\ -S & 0 & 0 \end{matrix}\right)$ 1/s', fontsize=9, ha='left', va='center',usetex=True)
