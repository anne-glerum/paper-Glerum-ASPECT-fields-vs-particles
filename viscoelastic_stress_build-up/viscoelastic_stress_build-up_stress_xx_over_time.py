...
names = [
         "ve_build-up_dt500_dh10km",
         "ve_build-up_dt500_dh5km",
         "ve_build-up_dt500_dh2-5km",
...
for name in names: 
  ...
  axins.plot(time/1e3,stress_xx_min/1e6,label=labels[counter],color=colors[counter],linestyle=linestyles[counter],marker=markers[counter])
  ax[1].plot(time/1e3,(stress_xx_min-tau_xx_analytical(time))/tau_xx_analytical(time)*100.,label=labels[counter],color=colors[counter],linestyle=linestyles[counter],marker=markers[counter])
