...
ax.text(-6.8,2.5,'$v_x=$\n-1.2616 mm/yr',fontsize=9, rotation = 0, va = 'top', ha = 'center', ma='left')
...
ax.text(41,2.5,'$v_x=$\n1.2616 mm/yr',fontsize=9, rotation = 0, va = 'top', ha = 'left', ma='right')
...
ax.arrow(20.5,0.2,4.4,-2,width=0.001,head_width=0, clip_on=False, fill=True, facecolor='black')
# Boundary velocity
