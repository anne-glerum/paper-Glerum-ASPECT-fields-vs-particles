...
names = [
         ...
         "ve_relaxation_dtc500_dte500_GR1_g0",
         "ve_relaxation_dtc500_dte500_GR2_g0",
         "ve_relaxation_dtc250_dte500_GR0_g0",
         "ve_relaxation_dtc250_dte500_GR1_g0",
         "ve_relaxation_dtc250_dte500_GR2_g0",
         "ve_relaxation_dtc125_dte500_GR0_g0",
         "ve_relaxation_dtc125_dte500_GR1_g0",
         "ve_relaxation_dtc125_dte500_GR2_g0",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 500 yr, dh = 10 km, previous',
...
colors = [color1, color3, color4, color5, color3, color4, color5, color3, color4, color5]
# Set the line styles
linestyles = ['solid', 'dashed', 'dashed', 'dashed', 'dashdot', 'dashdot', 'dashdot', 'dotted',  'dotted','dotted'] 
...
#ax[0].plot(time/1e3,20*np.exp(-1e10*time*yr_in_secs/1e22),label='analytical',color='black',marker="|",markevery=5)
...
# Save as pdf
plt.savefig('1_viscoelastic_relaxation_dte_isnot_dtc.pdf')    
