...
names = [
         ...
         "ve_relaxation_dtc250_dte250_GR2_g0_oldiscurrent",
         "ve_relaxation_dtc250_dte250_GR4_g0",
         "ve_relaxation_dtc250_dte250_GR8_g0",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
#          'dtc = 2500 yr, dte = 2500 yr, dh = 100 km',
          'dtc = 250 yr, dte = 250 yr, dh = 100 km',
          'dtc = 250 yr, dte = 250 yr, dh = 6.25 km',
          'dtc = 250 yr, dte = 250 yr, dh = 0.78125 km',
...
# Ranges of the axes
ax[0].set_xlim(0,50) # kyr
ax[0].set_ylim(0,21) # MPa
ax[1].set_xlim(0,50) # kyr
ax[1].set_ylim(0,2) # %
...
# Save as pdf
plt.savefig('1_viscoelastic_relaxation_dte_isnot_dtc_fields_dh.png')
