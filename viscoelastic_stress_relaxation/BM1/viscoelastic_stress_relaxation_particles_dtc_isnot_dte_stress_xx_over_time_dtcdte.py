...
names = [
         "ve_relaxation_particles_interpolatorcell_average_dtc2500_dte2500_GR0_g0",
         ...
         "ve_relaxation_particles_interpolatorcell_average_dtc125_dte125_GR0_g0",
         "ve_relaxation_particles_interpolatorcell_average_dtc25_dte25_GR0_g0",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 2500 yr, dh = 100 km',
          'dtc = dte = 500 yr, dh = 100 km',
          'dtc = dte = 250 yr, dh = 100 km',
          'dtc = dte = 125 yr, dh = 100 km',
          'dtc = dte = 25 yr, dh = 100 km',
         ]
...
# Save as png
plt.savefig('1_viscoelastic_relaxation_particles_dte_isnot_dtc_dtcdte.png')    
