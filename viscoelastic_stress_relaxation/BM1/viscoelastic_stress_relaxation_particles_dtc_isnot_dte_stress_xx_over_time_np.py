...
names = [
         ...
         "ve_relaxation_particles_interpolatorcell_average_dtc250_dte250_GR0_np16_g0",
         "ve_relaxation_particles_interpolatorcell_average_dtc250_dte250_GR0_np128_g0",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 250 yr, dh = 100 km, 4x4 part.',
          'dtc = dte = 250 yr, dh = 100 km, 16x16 part.',
          'dtc = dte = 250 yr, dh = 100 km, 128x128 part.',
         ]
