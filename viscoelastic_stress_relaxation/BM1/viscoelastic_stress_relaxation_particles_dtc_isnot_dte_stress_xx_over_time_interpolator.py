...
names = [
         ...
         "ve_relaxation_particles_interpolatornearest_neighbor_dtc250_dte250_GR0_g0",
         "ve_relaxation_particles_interpolatorbilinear_least_squares_dtc250_dte250_GR0_g0",
         "ve_relaxation_particles_interpolatorquadratic_least_squares_dtc250_dte250_GR0_g0",
        ]
tail = r"/statistics"

# The labels the graphs will get in the plot
labels = [
          'dtc = dte = 250 yr, dh = 100 km, CA',
          'dtc = dte = 250 yr, dh = 100 km, NN',
          'dtc = dte = 250 yr, dh = 100 km, BLS',
          'dtc = dte = 250 yr, dh = 100 km, QLS',
         ]
