...
def generate_and_run( refine, timestep ):
  prmfile = open("surface_topography_diffusion_constant_h.prm", "r")
  base_label = "surface_topography_diffusion_constant_h_"
  label = "dt" + str(timestep) + "_GR" + str(refine)
  new_prmfile = "surface_topography_diffusion_constant_h_" + label + ".prm"
...
refinements = [4,5,6]
timesteps = [1.57788e9,3.15576e9,6.31152e9]
