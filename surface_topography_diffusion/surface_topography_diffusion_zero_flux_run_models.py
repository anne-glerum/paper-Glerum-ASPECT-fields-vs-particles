...
def generate_and_run( refine, timestep ):
  prmfile = open("surface_topography_diffusion_zero_flux.prm", "r")
  base_label = "surface_topography_diffusion_zero_flux_"
  label = "dt" + str(timestep) + "_GR" + str(refine)
  new_prmfile = "surface_topography_diffusion_zero_flux_" + label + ".prm"
