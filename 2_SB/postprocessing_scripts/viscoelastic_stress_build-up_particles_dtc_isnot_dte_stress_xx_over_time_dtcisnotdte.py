...
names = [
         "ve_build-up_particles_interpolatorcell_average_dtc500_dte500_GR2_np4_g0",
         "ve_build-up_particles_interpolatorcell_average_dtc250_dte500_GR2_np4_g0",
         "ve_build-up_particles_interpolatorcell_average_dtc125_dte500_GR2_np4_g0",
         "ve_build-up_particles_interpolatorcell_average_dtc250_dte250_GR2_np4_g0",
         "ve_build-up_particles_interpolatorcell_average_dtc125_dte250_GR2_np4_g0",
         "ve_build-up_particles_interpolatorcell_average_dtc62.5_dte250_GR2_np4_g0",
        ]
tail = r"/statistics"
...
colors = [color2, color3, color4, color2, color3, color4, color5, color1, color3, color5]
# Set the line styles
...
# Save
plt.savefig('2_viscoelastic_build-up_particles_dtc_isnot_dte_dtcisnotdte.png',dpi=300)
