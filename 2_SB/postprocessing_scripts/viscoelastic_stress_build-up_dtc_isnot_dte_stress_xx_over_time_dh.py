...
names = [
         "ve_build-up_main_dtc250_dte250_GR1_1",
         "ve_build-up_main_dtc250_dte250_GR2_1",
         "ve_build-up_main_dtc250_dte250_GR3_1",
         "ve_build-up_main_dtc250_dte250_GR4_1",
        ]
tail = r"/statistics"
...
ax[0].set_ylabel(r"Stress $\tau_{\text{xx}}$ [MPa]")
...
# Save
plt.savefig('2_viscoelastic_build-up_dtc_isnot_dte_dh.png',dpi=300)
