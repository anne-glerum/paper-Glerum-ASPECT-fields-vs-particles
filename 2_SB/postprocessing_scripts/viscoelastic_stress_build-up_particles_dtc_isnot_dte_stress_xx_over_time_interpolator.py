...
names = [
         ...
         "ve_build-up_particles_interpolatorharmonic_average_dtc250_dte250_GR2_np4_g0",
         "ve_build-up_particles_interpolatornearest_neighbor_dtc250_dte250_GR2_np4_g0_1",
         "ve_build-up_particles_interpolatorbilinear_least_squares_dtc250_dte250_GR2_np4_g0_1",
         "ve_build-up_particles_interpolatorquadratic_least_squares_dtc250_dte250_GR2_np4_g0_1",
        ]
tail = r"/statistics"
...
for name in names: 
  ...
  ax[0].plot(time/1e3,stress_xx_min/1e6,label=labels[counter],color=colors[counter],linestyle=linestyles[counter],marker=markers[counter],markevery=dmark+counter,fillstyle='none')
  ax[1].plot(time/1e3,(stress_xx_min-tau_xx_analytical(time))/tau_xx_analytical(time)*100.,label=labels[counter],color=colors[counter],linestyle=linestyles[counter],marker=markers[counter],markevery=dmark+counter,fillstyle='none')
...
# Save
plt.savefig('2_viscoelastic_build-up_particles_dtc_isnot_dte_interpolator.png')    
