...
names = [
         "ve_build-up_particles_main_interpolatorcell_average_dtc500_dte500_GR2_np41",
         "ve_build-up_particles_main_interpolatorcell_average_dtc250_dte250_GR2_np41",
         "ve_build-up_particles_main_interpolatorcell_average_dtc125_dte125_GR2_np41",
         "ve_build-up_particles_main_interpolatorcell_average_dtc62.5_dte62.5_GR2_np41",
        ]
tail = r"/statistics"
...
# Save
plt.savefig('2_viscoelastic_build-up_particles_dtc_isnot_dte_dtcisdte.png',dpi=300)
