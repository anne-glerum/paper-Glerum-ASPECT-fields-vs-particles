...
# Annotations material properties
ax.text(35,45,r'$\dot{\epsilon} = \binom{10^{-14} \, \,\,\,\,\,\,\,\,\,\,\,\,\,\,\, 0}{\,\,0\,\,\,\,\,\,\,\,\,\,\,\,\,  \, -\!10^{-14}}$ 1/s', fontsize=9, ha='left', va='center')
ax.text(35,35,r'$\mathrm{W} = \binom{0 \; 0}{0 \; 0}$ 1/s', fontsize=9, ha='left', va='center')
...
# Save Figure
plt.savefig('2_viscoelastic_build-up_setup.png',bbox_inches="tight",dpi=300)
plt.close()
